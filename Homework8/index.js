...
//Bài 2:
{
    ...
    function stopFunct() {
        clearInterval(intervalVar, 1000);
    }
}
...

{
    ...
    function showQuote() {
        randomIndex = Math.floor(((Math.random()) * quoteTest.length));
        document.getElementById("quote-text").textContent = '';
        document.getElementById("quote-author").textContent = '';
        document.getElementById("quote-text").textContent = quoteTest[randomIndex].quoteText;
        document.getElementById("quote-author").textContent = quoteTest[randomIndex].quoteAuthor;
    }
    showQuote();
}   